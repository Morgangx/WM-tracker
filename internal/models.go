...
type RequestInput struct {
	Slug string // snake case name of the item e.g. Protea Prime Set == "protea_prime_set"
	Rank int8   // Optional specific rank of the item
	WTB  bool   // WTB request means WTS for user
	WTS  bool   // WTS request means WTB for user
}
